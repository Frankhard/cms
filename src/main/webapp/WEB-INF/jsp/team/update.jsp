           ...
           <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <select id="shipping" name="type" class="valid">
                    <option value="校级"  ${obj.type == '校级' ? "selected" : ""}>校级</option>
                    <option value="院级" ${obj.type == '院级' ? "selected" : ""}>院级</option>
                  </select>
              </div>
          </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="number" id="username" name="ministerCount" value="${obj.ministerCount}" min="0" required="" lay-verify="required"
                           autocomplete="off" class="layui-input">
                </div>
            </div>
