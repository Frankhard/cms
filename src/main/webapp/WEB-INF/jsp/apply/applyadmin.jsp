	...
	private String password;密码 -->
	                   ...
	                   <c:if test="${data.status == 2}"> 审核未通过</c:if>
	                    ...
	                    <td class="td-manage">
	                     <c:if test="${data.status == 0}"> 
				              <a title=""  href="${ctx}/apply/tysuper?id=${data.id}">
				              同意
				              </a>
				              <a title=""  href="${ctx}/apply/bhsuper?id=${data.id}">
				              驳回
				              </a>
      ...
      <div class="page">
        <div>
          <div class="pagelist">
		        <!-- 分页开始 -->
					      <pg:pager  url="${ctx}/apply/findBySqladmin" maxIndexPages="5" items="${pagers.total}"  maxPageItems="15" export="curPage=pageNumber" >
							<pg:last>  
