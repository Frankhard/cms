...
<body>
    ...
    <div class="x-body">
	    <div class="layui-row">
	        <form class="layui-form layui-col-md12 x-so" method="post" action="${ctx}/activity/findBySql">
	...
	private Integer status;0 新建  1 审核通过 2 审核未通过 -->
	                  ...
	                  <td>
	                   ...
	                   <c:if test="${data.status == 2}"> 审核未通过</c:if>
	                    ...
	                    <c:if test="${data.status != 1}"> 
	                     <a title="编辑"  href="${ctx}/activity/update?id=${data.id}">
      ...
      <div class="page">
        <div>
          <div class="pagelist">
		        <!-- 分页开始 -->
					      <pg:pager  url="${ctx}/activity/findBySql" maxIndexPages="5" items="${pagers.total}"  maxPageItems="15" export="curPage=pageNumber" >
