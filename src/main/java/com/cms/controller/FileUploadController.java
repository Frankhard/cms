...
public class FileUploadController {
    ...
    @PostMapping("/upload")
    public Map<String,Object> upload(@RequestParam(value = "upfile", required = false)MultipartFile uploadFile, HttpServletRequest request){
    	Map<String,Object> map = new HashMap<String,Object>();

        SimpleDateFormat sdf = new SimpleDateFormat("yyyy/MM/dd/");
        //构建文件上传所要保存的"文件夹路径"--这里是相对路径，保存到项目根路径的文件夹下
        String realPath=Constant.FILE_ROOT_UPLOAD+"/";
